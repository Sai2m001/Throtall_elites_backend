...
public class Product {
    ...
    @Column(name = "dimension_mm_l_w_h",nullable = false, length = 400)
    private String dimensionMmLWH;

    @Column(name = "engine_capacity_cc", nullable = false)
    private Integer engineCapacityCc;

    @Column(name = "engine_type", nullable = false, length = 800)
    private String engineType;

    @Column(name = "max_power", nullable = false, length = 800)
    private String maxPower;

    @Column(name = "max_torque", nullable = false, length = 800)
    private String maxTorque;
    @Column(name = "mileage_kmpl", length = 100)
    private String mileageKmpl;

    @Column(name = "top_speed_kmph", length = 100)
    private String topSpeedKmph;

    @Column(name = "gearbox", length = 100)
    private String gearbox;

    @Column(name = "clutch_type", length = 100)
    ...
    @Column(name = "front_tyre", length = 100)
    private String frontTyre;

    @Column(name = "rear_tyre", length = 100)
    private String rearTyre;

    @Column(name = "tyre_type", length = 100)
    private String tyreType;

    @Column(name = "fuel_tank_capacity_l", length = 100)
    private String fuelTankCapacityL;

    @Column(name = "seat_height_mm", length = 100)
    private String seatHeightMm;

    @Column(name = "ground_clearance_mm", length = 100)
    private String groundClearanceMm;

    @Column(name = "kerb_weight_kg", length = 100)
